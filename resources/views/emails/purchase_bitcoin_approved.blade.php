...
<body>
	...
	<p>The status for your transaction of {{ $units }} units of perfect money, with the reference no: {{ $ref_no }}  has been changed from "{{ $initial_status }}" to "{{ $status }}".</p>

	<p>You can login to your dashboard and view the transaction.</p>

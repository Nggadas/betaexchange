  ...
  <div id="tab3" class="tab-pane fade">
    @if(!empty($fund_details[0]))
        ...
        <div class="form-group">
            ...
            <input type="text" name="batch_no" value="{{ $fund_details[0]->batch_number }}" class="form-control input-lg" readonly="true" >
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="pm_account_no">PM Account Number:</label>
            <input type="text" name="pm_account_no" value="{{ $fund_details[0]->pm_account_no }}" class="form-control input-lg" readonly="true" >
        </div>
    @else
        <div class="form-group">

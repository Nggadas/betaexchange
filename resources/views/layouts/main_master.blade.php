...
<head>
    ...
    <meta name="keywords" content="perfect money in Nigeria, bitcoin, perfect money, sell perfect money, sell bitcoin, buy Perfect Money, buy bitcoin, exchanger, egbeda, buy bitcoin in egbeda, ecurrency exchanger, bitcoin for cash, naira">
    <meta name="description" content="Betaexchangeng is a leading Nigerian Bitcoin exchange where users can buy and sell perfect money, bitcoin and other e-currencies with Nigerian Naira at best rate.">

    <meta name="geo.region" content="NG-LA" />
    <meta name="geo.placename" content="Lagos" />
    <meta name="geo.position" content="6.599453;3.29298" />
    <meta name="ICBM" content="6.599453, 3.29298" />


    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Buy or sell perfect money and bitcoin in Nigeria - Betaexchangeng</title>
    <!--Google Fonts-->
 <link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'>
  <link href='http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
   ...
   <!--  <link href="{{ asset('css/font/css/fontawesome.min.css') }}" rel="stylesheet"> -->
   ...
   <link href="{{ asset('css/dataTables.responsive.css') }}" rel="stylesheet"  media="all">
    ...
    <link href="{{ asset('css/custom.css?v=1.2') }}" rel="stylesheet" media="all">
            ...
            <div class="pull-right">
              <ul class="brands brands-inline brands-tn brands-circle main">
                  <li><a href="https://twitter.com/betaexchangeng"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <li><a href="https://api.whatsapp.com/send?phone=2349091909346&text=Hello Betaexchangeng"><i class="fa fa-whatsapp"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="navbar-collapse collapse navbar-right" >
              <ul class="nav navbar-nav navbar-main-menu">
                  @if (Auth::check())
                      ...
                      @else
                          <li><a href="{{ url('userdashboard') }}" data-hover="{{Auth::user()->first_name}}">My Dashboard</a></li>
          ...
          <div class="row">
              <div class="col-md-4">
                  <h3><i class="fa fa-flag"></i>About</h3>
                   ...
                   <p>Betaexchangeng is one the leading e-currency service providers in Lagos, Nigeria, specializing in the buying, selling and exchanging of e-currencies like bitcoin, perfect money in Nigeria. Driven by our vision and we have adopted several mission objectives to achieve this.</p>
                ...
                <div class="col-md-4 hidden-xs hidden-sm">
                  <h3><i class="fa fa-envelope"></i>Social Media</h3>
                   ...
                   <ul class="brands brands-inline brands-sm brands-transition brands-circle" >
                      <li style="margin-left: -150px;"><a href="https://www.facebook.com/BetaEx17/" class="brands-facebook"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/betaexchangeng" class="brands-twitter"><i class="fa fa-twitter"></i></a></li>
